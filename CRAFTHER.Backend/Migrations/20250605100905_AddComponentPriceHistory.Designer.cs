...
namespace CRAFTHER.Backend.Migrations
{
    ...
    [Migration("20250605100905_AddComponentPriceHistory")]
    partial class AddComponentPriceHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.ComponentPriceHistory", b =>
                {
                    b.Property<Guid>("ComponentPriceHistoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ComponentPriceHistoryId");
                    ...
                    b.ToTable("ComponentPriceHistories");
                });

            modelBuilder.Entity("CRAFTHER.Backend.Models.ItemCategory", b =>
                {
                    b.Property<Guid>("ItemCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6468),
                            Description = "Raw materials used in food and beverage production.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6469)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000002"),
                            CategoryName = "Beverage Ingredient",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6479),
                            Description = "Raw materials used in beverage production.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6480)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000003"),
                            CategoryName = "Finished Food Product",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6484),
                            Description = "Ready-to-sell food items.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6484)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000004"),
                            CategoryName = "Finished Beverage Product",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6493),
                            Description = "Ready-to-sell beverage items.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6493)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000005"),
                            CategoryName = "Fabric",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6496),
                            Description = "Textile materials for garment production.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6497)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000006"),
                            CategoryName = "Accessory (Clothing)",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6499),
                            Description = "Buttons, zippers, threads, etc. for clothing.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6500)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000007"),
                            CategoryName = "Finished Garment",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6503),
                            Description = "Ready-to-sell clothing items.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6504)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000008"),
                            CategoryName = "Packaging Material",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6506),
                            Description = "Materials used for product packaging.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6507)
                        },
                        new
                        {
                            ItemCategoryId = new Guid("c0000000-0000-0000-0000-000000000009"),
                            CategoryName = "Other",
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6510),
                            Description = "Miscellaneous items not fitting other categories.",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6510)
                        });
                });
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.Level", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6638),
                            Description = "Just starting your BOM journey.",
                            LevelName = "BOM Novice",
                            LevelNumber = 1,
                            RequiredPoints = 0,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6639)
                        },
                        new
                        {
                            LevelId = new Guid("f2a3b4c5-d6e7-f8a9-b0c1-d2e3f4a5b6c7"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6644),
                            Description = "Learning the ropes of recipe management.",
                            LevelName = "Recipe Apprentice",
                            LevelNumber = 2,
                            RequiredPoints = 100,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6644)
                        },
                        new
                        {
                            LevelId = new Guid("a0b1c2d3-e4f5-a6b7-c8d9-e0f1a2b3c4d5"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6647),
                            Description = "Mastering your ingredient knowledge.",
                            LevelName = "Ingredient Explorer",
                            LevelNumber = 3,
                            RequiredPoints = 300,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6647)
                        },
                        new
                        {
                            LevelId = new Guid("b1c2d3e4-f5a6-b7c8-d9e0-f1a2b3c4d5e6"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6650),
                            Description = "Becoming an expert in cost analysis.",
                            LevelName = "Costing Pro",
                            LevelNumber = 4,
                            RequiredPoints = 600,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6650)
                        },
                        new
                        {
                            LevelId = new Guid("c2d3e4f5-a6b7-c8d9-e0f1-a2b3c4d5e6f7"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6653),
                            Description = "The ultimate CRAFTHER champion!",
                            LevelName = "CRAFTHER Master",
                            LevelNumber = 5,
                            RequiredPoints = 1000,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6653)
                        });
                });
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.QuestType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6587),
                            Description = "Quests that refresh daily.",
                            QuestTypeName = "DAILY",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6587)
                        },
                        new
                        {
                            QuestTypeId = new Guid("b2c3d4e5-f6a1-2345-cdef-0123456789ab"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6591),
                            Description = "Quests that refresh weekly.",
                            QuestTypeName = "WEEKLY",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6591)
                        },
                        new
                        {
                            QuestTypeId = new Guid("c3d4e5f6-a1b2-3456-7890-abcdef012345"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6595),
                            Description = "Core progression quests.",
                            QuestTypeName = "MAIN_STORY",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6596)
                        },
                        new
                        {
                            QuestTypeId = new Guid("d4e5f6a1-b2c3-4567-890a-bcdef0123456"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6597),
                            Description = "Difficult, one-time challenges.",
                            QuestTypeName = "CHALLENGE",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(6598)
                        });
                });
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.StockAdjustmentType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6130),
                            Effect = "Increase",
                            Name = "Receive",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6131)
                        },
                        new
                        {
                            AdjustmentTypeId = new Guid("02a1b2c3-d4e5-6f78-9012-3456789abc02"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6138),
                            Effect = "Decrease",
                            Name = "Issue",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6138)
                        },
                        new
                        {
                            AdjustmentTypeId = new Guid("03a1b2c3-d4e5-6f78-9012-3456789abc03"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6145),
                            Effect = "Increase",
                            Name = "Positive Adjustment",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6146)
                        },
                        new
                        {
                            AdjustmentTypeId = new Guid("04a1b2c3-d4e5-6f78-9012-3456789abc04"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6171),
                            Effect = "Decrease",
                            Name = "Negative Adjustment",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6172)
                        },
                        new
                        {
                            AdjustmentTypeId = new Guid("05a1b2c3-d4e5-6f78-9012-3456789abc05"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6177),
                            Effect = "Increase",
                            Name = "Production In",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6178)
                        },
                        new
                        {
                            AdjustmentTypeId = new Guid("06a1b2c3-d4e5-6f78-9012-3456789abc06"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6186),
                            Effect = "Decrease",
                            Name = "Consumption",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 985, DateTimeKind.Utc).AddTicks(6187)
                        });
                });
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.SubscriptionPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(5365),
                            ...
                            Price = 0.00m,
                            StorageSpaceMB = 50,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(5365)
                        },
                        new
                        {
                            ...
                            CanIntegratePOS = false,
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(5376),
                            ...
                            Price = 199.00m,
                            StorageSpaceMB = 500,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(5376)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(5380),
                            ...
                            Price = 499.00m,
                            StorageSpaceMB = 5000,
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 4, 3, DateTimeKind.Utc).AddTicks(5380)
                        });
                });
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.UnitGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6399),
                            UnitGroupName = "Weight",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6400)
                        },
                        new
                        {
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6409),
                            UnitGroupName = "Volume",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6410)
                        },
                        new
                        {
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6414),
                            UnitGroupName = "Count",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6414)
                        },
                        new
                        {
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000004"),
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6419),
                            UnitGroupName = "Length",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 977, DateTimeKind.Utc).AddTicks(6419)
                        });
                });
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6000),
                            IsBaseUnit = true,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000001"),
                            UnitName = "Gram",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6001)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6030),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000001"),
                            UnitName = "Kilogram",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6031)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6042),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000001"),
                            UnitName = "Milligram",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6043)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6065),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000001"),
                            UnitName = "Pound",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6066)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6078),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000001"),
                            UnitName = "Ounce",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6079)
                        },
                        new
                        {
                            ...
                            Abbreviation = "ml",
                            ConversionFactorToBaseUnit = 1.0m,
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6091),
                            IsBaseUnit = true,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000002"),
                            UnitName = "Milliliter",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6092)
                        },
                        new
                        {
                            ...
                            Abbreviation = "l",
                            ConversionFactorToBaseUnit = 1000.0m,
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6104),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000002"),
                            UnitName = "Liter",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6105)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6114),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000002"),
                            UnitName = "Teaspoon",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6115)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6122),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000002"),
                            UnitName = "Tablespoon",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6124)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6137),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000002"),
                            UnitName = "Cup",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6138)
                        },
                        new
                        {
                            ...
                            Abbreviation = "pcs",
                            ConversionFactorToBaseUnit = 1.0m,
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6148),
                            IsBaseUnit = true,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000003"),
                            UnitName = "Piece",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6149)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6163),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000003"),
                            UnitName = "Dozen",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6163)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6195),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000003"),
                            UnitName = "Pair",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6196)
                        },
                        new
                        {
                            ...
                            Abbreviation = "m",
                            ConversionFactorToBaseUnit = 1.0m,
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6206),
                            IsBaseUnit = true,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000004"),
                            UnitName = "Meter",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6207)
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6224),
                            IsBaseUnit = false,
                            UnitGroupId = new Guid("a0000000-0000-0000-0000-000000000004"),
                            UnitName = "Centimeter",
                            UpdatedAt = new DateTime(2025, 6, 5, 10, 9, 3, 979, DateTimeKind.Utc).AddTicks(6226)
                        });
                });
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.Component", b =>
                {
                    ...
                    b.HasOne("CRAFTHER.Backend.Models.ItemCategory", "ItemCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("CRAFTHER.Backend.Models.ComponentPriceHistory", b =>
                {
                    b.HasOne("CRAFTHER.Backend.Models.ApplicationUser", "ChangedByUser")
                        .WithMany()
